...
import { getContentForCustomerPost, getSlugsForPost } from '@/content/queries'
import Illustration from '@/public/images/page-illustration.svg'
import { documentToReactComponents } from '@contentful/rich-text-react-renderer'
import Image from 'next/image'
import Link from 'next/link'
import RelatedPosts from '../single-post/related-posts'


// http://localhost:3000/customers/how-canon-leverages-stellar-x-to-onboard-new-hosts  

export const generateStaticParams = async () => {
  const data = await getSlugsForPost();
  return data.customerPostCollection.items;
};

export default async function CustomerSinglePage({ params: {
    slug
} }: {
    params: {
  ...
  const data = await getContentForCustomerPost(slug)
                    ...
                    <div className="px-5 py-6">
                      <div className="mb-5">
                        <div className="flex items-center space-x-4">
                          <Image src={content.customer.logo.url} alt={content.customer.logo.fileName}  width={64} height={64}  />
